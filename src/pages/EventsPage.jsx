...
import { Box, Heading, Text, Image, SimpleGrid, Spinner, Flex, Avatar, Button, Input, useDisclosure } from '@chakra-ui/react';
  ...
  return (
    <Box padding="2rem">
      <Flex justify="space-between" align="center" mb="1rem">
        ...
        <Button colorScheme="blue" onClick={onOpen}>Toevoegen</Button>
      </Flex>
  ...
  <Heading size="md" mb={2}>
    {event.title}
      ...
      <NewEventForm
        ...
        onCategoryAdded={(newCategory) => setCategories(prev => [...prev, newCategory])}
      />
    </Box>
  );
};
